...
std::string Utilities__::ToDecAddressString(size_t address)
{
...
std::string Utilities__::ToHexAddressString(size_t address)
{
  std::ostringstream oss;
